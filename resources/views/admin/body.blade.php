              ...
              <div class="row">
                ...
                <div class="col-3">
                  <div class="icon icon-box-success ">
                    <i class="icon-md mdi mdi-cellphone-link"></i>
                  </div>
                </div>
              </div>
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-3">
                  <div class="icon icon-box-success">
                    <i class="icon-md mdi mdi-clipboard-check"></i>
                  </div>
                </div>
              </div>
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-3">
                  <div class="icon icon-box-success ">
                    <i class="icon-md mdi mdi-cash"></i>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-8 col-sm-12 col-xl-8 my-auto">
                  <div class="d-flex d-sm-block d-md-flex align-items-center">
                    <h2 class="mb-0">{{$total_delivered}} orders </h2>
                    <p class="text-success ml-2 mb-0 font-weight-medium">+1.1%</p>
                  </div>
                  <h6 class="text-muted font-weight-normal">2.82% Since last month</h6>
                </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-8 col-sm-12 col-xl-8 my-auto">
                  <div class="d-flex d-sm-block d-md-flex align-items-center">
                    <h2 class="mb-0">{{$total_processing}} orders</h2>
                    <p class="text-success ml-2 mb-0 font-weight-medium"></p>
                  </div>
                  <h6 class="text-muted font-weight-normal">Please check orders</h6>
                </div>
                <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-8 col-sm-12 col-xl-8 my-auto">
                  ...
                  <h6 class="text-muted font-weight-normal">0% Since last month</h6>
                </div>
                <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                  <i class="icon-lg mdi mdi-alert text-warning ml-auto"></i>
                </div>
              </div>
            </div>
          </div>
